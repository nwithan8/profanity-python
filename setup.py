...
__title__ = "profanity-api"
__author__ = 'Nate Harris'
__author_email__ = 'n8gr8gbln@gmail.com'
__github_username__ = "nwithan8"
__github_repo__ = "profanity-python"
__copyright__ = "Copyright © YEARADDEDBYGITHUB - Nate Harris"
__license__ = 'GNU General Public License v3 (GPLv3)'
__description__ = "A complete Python client for the profanity.dev API"
__keywords__ = ["profanity", "curse", "language", "swear", "moderation", "API", "client", "JSON"]
...
def __supported_python_versions__() -> List[str]:
    ...
    with open(os.path.join(os.path.dirname(__file__), "profanity_api", "PYTHON_VERSIONS.json")) as f:
        versions = f.read()
